...
> This KISS-inspired attitude of the Arch creators, packagers, maintainers, and users implies that the Arch software catalog is rich, highly configurable, and _vanilla_.
...
or if you really _hate_ to build the generic [dkms](https://wiki.archlinux.org/index.php/Dynamic_Kernel_Module_Support) modules, **you can install a certain specific `ZFS` package that matches your kernel**:
